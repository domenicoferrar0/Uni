...
public class ControllerCDL {
	...
	public ResponseEntity<List<String>> getForMenu(){
		List<String> cdls = service.findForMenu(); //STO SEMPLICEMENTE RITORNANDO I NOMI DEL CDL, PER IL SELECT DI STUDENTE
	...
	public ResponseEntity<CdlDTO> getByNome(@RequestParam(value = "nome") String nome) {
		CdlDTO cdl = service.findByNome(nome); //404 SE NON LO TROVA
